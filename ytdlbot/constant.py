...
__author__ = "Omiya <ominduanjana@gmail.com>"
...
class BotText:
    start = "Welcome to YouTube Download Sl bot. Type /help for more information."

    help = f"""
1. This bot should works at all times. If it doesn't, try to send the link again or DM @OminduAnjana
...
5. Source code for this bot will always stay open, here-> https://github.com/tgbot-collection/ytdlbot
    ...
    about = "YouTube-D Bot by @OminduAnjana. Open source on GitHub: https://github.com/tgbot-collection/ytdlbot"
